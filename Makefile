...
deploy: 
	@gcloud run deploy gridoai-api --image gcr.io/lucid-arch-387422/gridoai-api --platform managed --region=southamerica-east1 --allow-unauthenticated --memory=512Mi --env-vars-file .env.yaml --project lucid-arch-387422
